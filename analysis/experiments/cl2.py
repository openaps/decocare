...
class BadDeviceCommError(ProtocolError):
    pass


class DeviceCommsError(ProtocolError):
    pass


class RFFailed(DeviceCommsError):
    pass


class AckError(DeviceCommsError):
    pass
...
class Link(link.Link):
    ...
    def sendComLink2Command(self, msg, a2=0x00, a3=0x00):
        ...
        self.write(msg)
        return retry(self.checkAck, sleep=0.01)
...
class Device:
    ...
    def readDeviceDataIO(self):
        ...
        # crc check
        log.info(
            "readDeviceDataIO:msgCRC:{!r}:expectedCRC:{!r}:data:{}".format(
    ...
    def readData(self):
        ...
        log.info(
            "readData; foreign response should be at least 14 bytes? {} {}".format(
