...
def get_argparser():
    ...
    parser.add_argument(
        "--port", "-p", default="/dev/ttyUSB0", help="path to serial port"
    )

    parser.add_argument(
        "--verbosity", "-v", default=0, action="count", help="verbosity"
    )
    ...
    parser.add_argument(
        "serial", default="208850", help="serial number of target pump (eg. 208850)"
    )
...
class App:
    _log_map = {0: logging.INFO, 1: logging.DEBUG, 2: logging.WARN, 3: logging.DEBUG}
