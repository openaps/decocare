  ...
  Under no circumstance is it intended to deliver therapy.
    ...
    def main(self, args):
        ...
        if args.command == "ManualCommand":
            ...
            resp = self.exec_request(
                self.pump,
                msg,
                args=kwds,
                dryrun=args.dryrun,
                render_hexdump=False,
                save=args.save,
    ...
    def customize_parser(self, parser):
        ...
        subparsers = parser.add_subparsers(
            help="Main thing to do between --prefix and--postfix", dest="command"
        )
        sleep_parser = subparsers.add_parser(
            "sleep", help="Just sleep between command sets"
        )
        ...
        all_parser.add_argument(
            "code", type=int, help="The opcode to send to the pump."
        )
