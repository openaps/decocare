...
class LatestActivity(cli.CommandApp):
  ...
  Query pump for latest activity.
    ...
    def customize_parser(self, parser):
        ...
        parser.add_argument(
            "minutes", type=int, nargs="?", default=30, help="[default: %(default)s)]"
        )
        return parser
    ...
    def find_records(self, page, larger=None):
        ...
        for record in records:
            ...
            print(
                "  * should quit",
                record.get("timestamp") < self.since.isoformat(),
                self.enough_history,
            )
